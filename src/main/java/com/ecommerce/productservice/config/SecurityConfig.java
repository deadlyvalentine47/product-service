    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/products/search", "/api/products/random", "/api/products/{id}").permitAll()
                        .requestMatchers("/api/products/**").authenticated() // Require authentication for POST, DELETE, PUT.
